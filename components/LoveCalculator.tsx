...
const LoveCalculator: React.FC = () => {
  ...
  const shareResult = async () => {
    ...
    const shareText = `ຜົນການຄິດໄລ່ຄວາມຮັກຂອງ ${name1} ແລະ ${name2} ແມ່ນ ${score}%! ${getVerdict(score)} ມາທົດສອບທີ່ LoveVerse.`;
    
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'LoveVerse Compatibility Result',
          text: shareText,
      ...
      alert("ບໍ່ຮອງຮັບການແບ່ງປັນໃນບຣາວເຊີນີ້. ຂໍ້ຄວາມຖືກສ້າງແລ້ວ: " + shareText);
    }
  };
